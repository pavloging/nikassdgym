...
import lyingDumbbellFlyes from "../assets/video/chest-arms/lyingDumbbellFlyes.mp4";
import barbellCurl from "../assets/video/chest-arms/barbellCurl.mp4";
...
const chestArms = [
  ...
  {
    name: "Попеременный подъем на бицепс",
    src: alternateBicepsCurl,
    img: alternateBicepsCurlImg,
  },
  {
    name: "Бабочка",
    src: butterfly,
  ...
  {
    name: "Трицепс из упора",
    src: tricepsFromEmphasis,
    img: tricepsFromEmphasisImg,
  },
  {
    name: "Разведение гантелей лежа",
    src: lyingDumbbellFlyes,
